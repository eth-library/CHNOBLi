...
es_171726375 = {
    ...
    "biographicalOrHistoricalInformation": [
        "Henley Management College, Henley Business School, Univ. of Reading"
    ],
}
es_1089259662 = {
                ...
                "hits": [
                    ...
                    },
                    {
                        ...
                        "_source": {
                            ...
                            "biographicalOrHistoricalInformation": [
                                "UNA School of Business, Belo Horizonte, Brazil (1999)"
                            ],
                            "dateOfBirth": ["1959"],
                        },
                    },
                    ...
                    },
                    {
                        ...
                        "_source": {
                            ...
                            "biographicalOrHistoricalInformation": [
                                "Chairman of the Third Lausanne Congress, Cape Town 2010"
                            ],
                        },
                    },
                    {
    ...
    (
        ...
        True,
        {
            ...
            "123137241": {
                ...
                "varName": {"Bedel, Joannes", "Bedel, Johannes", "Bedle, Jean"},
            },
            "1217500138": {
                "prefForename": {"Jean"},
                "prefSurname": {"Borel"},
                ...
                "gid": {"1217500138"},
                "score": 0.9295216727551718,
                "varName": {"Borel, Iean", "Borellus, Joannes", "Borellus, Johannes"},
            },
        },
        {
            "hits": {
                ...
                "hits": [
                    {
                        ...
                        "_source": {
                            ...
                            "variantNameEntityForThePerson": [
                                {"forename": ["Jan"], "surname": ["Borel"]},
                                {"forename": ["J."], "surname": ["Borel"]},
                                {"personalName": ["D. Spero"]},
                                {"forename": ["Jules"], "surname": ["Borel"]},
                                {"personalName": ["J.B."]},
                            ],
                            "type": [
                                "Person",
                            ...
                            "deprecatedUri": ["https://d-nb.info/gnd/116248661"],
                            "biographicalOrHistoricalInformation": [
                                "Schweizer jüdischer Sprachforscher, Verleger, Hauptmann, Wegbereiter des Esperanto in Deutschland"
                            ],
                    ...
                    },
                    {
                        ...
                        "_source": {
                            ...
                            "dateOfDeath": ["1657"],
                            "variantNameEntityForThePerson": [
                                {"forename": ["Johannes"], "surname": ["Bedel"]},
                                {"forename": ["Joannes"], "surname": ["Bedel"]},
                                {"forename": ["Jean"], "surname": ["Bedle"]},
                            ],
                            "type": [
                                "AuthorityResource",
                                "Person",
                    ...
                    },
                    {
                        ...
                        "_source": {
                            ...
                            "variantNameEntityForThePerson": [
                                {"forename": ["Johannes"], "surname": ["Borellus"]},
                                {"forename": ["Iean"], "surname": ["Borel"]},
                                {"forename": ["Joannes"], "surname": ["Borellus"]},
                            ],
                            "type": [
                                "Person",
                                "AuthorityResource",
...
PARAMS_search_person_wikidata = [
    ...
    (
        ...
        True,
        {
            ...
            "101695268": {
                "desc": {"Swiss Esperantist (1868-1946)"},
...
PARAMS_convert_wikidata_format_kibana = [
    ...
    (
        {"labels": "Douglas Birdsall", "instanceOf": ["Q5"], "GND_ID": ["1119113008"]},
        {
            "gid": {"1119113008"},
            "name": {"Douglas Birdsall"},
            "prefSurname": {"Birdsall"},
        ...
        (
            ...
            [
                ...
                },
                {
                    ...
                    "pid": 100,
                    "pageNames": "abc-001_1234_123_0100.txt",
                    "pageNo": 100,
                    "sentenceNo": 30,
                    "positions": [
                        "789,2016,48,22:main",
            ...
            [
                {
                    ...
                    "pid": 9,
                    "pageNames": "abc-001_1234_123_0009.txt",
                    "pageNo": 9,
                    "sentenceNo": 27,
                    "positions": ["865,1781,49,22:main", "924,1780,100,23:main"],
                    "type": "PER",
                ...
                },
                {
                    ...
                    "pid": 10,
                    "pageNames": "abc-001_1234_123_0010.txt",
                    "pageNo": 10,
                    "sentenceNo": 28,
                    "positions": [
                        "789,2016,48,22:main",
                ...
                },
                {
                    ...
                    "pid": 11,
                    "pageNames": "abc-001_1234_123_0011.txt",
                    "pageNo": 11,
                    "sentenceNo": 29,
                    "positions": ["865,1781,49,22:main", "924,1780,100,23:main"],
                    "type": "PER",
    ...
    (
        ...
        [
            ...
            },
            {
                "tokens": ["BASELS"],
                "type": "LOC",
                "references": {(7, "mnl", 8): [(10, "159", "159"), (11, "753", "753")]},
            },
        ],
        [
            {
...
PARAMS_clean_up_aggregation_places = [
    (
        [{"name": "zurich", "references": {}}, {"name": "basel", "references": {}}],
        0,
        [
...
PARAMS_only_abbrev_firstname_match = [
    (
        {
            "info": {
                "lastnames": "z",
...
gt_dict_with_gnd = {
    ...
    "other": [],
    "references": {
        "aaa-001_2004_000_0012.txt": {"refs": [{"sent": 0, "coords": ["a"]}]}
    },
    "type": "PER",
    "id": 0,
    "gt_gnd_id": "a",
...
gt_dict_with_multiple_refs = {
    ...
    "references": {
        "aaa-001_2004_000_0012.txt": {
            "refs": [{"sent": 0, "coords": ["a"]}, {"sent": 1, "coords": ["b"]}]
        }
    },
    "type": "PER",
    "id": 0,
...
linked_dict_with_extra_refs = {
    ...
    "references": {
        "aaa-001_2004_000_0012.txt": {
            "refs": [{"sent": 0, "coords": ["a"]}, {"sent": 2, "coords": ["c"]}]
        }
    },
    "type": "PER",
    "id": 0,
...
PARAMS_get_main_name = [
    ({"firstname": "x y", "lastname": "z", "abbr_firstname": [], "other": []}, "x y z"),
    (
        {"firstname": "x y", "lastname": "z", "abbr_firstname": ["b"], "other": []},
        "x y z",
    ),
    ({"firstname": "", "lastname": "z", "abbr_firstname": ["b"], "other": []}, "b z"),
    (
        {"firstname": "x y", "lastname": "", "abbr_firstname": ["b"], "other": []},
        "x y b",
    ),
    ({"firstname": "", "lastname": "", "abbr_firstname": ["b"], "other": []}, "b"),
    ({"firstname": "", "lastname": "", "abbr_firstname": [], "other": ["d"]}, "d"),
    ({"firstname": "", "lastname": "", "abbr_firstname": [], "other": []}, "--"),
    ({}, "--"),
]
...
PARAMS_tokenize = [
    ...
    (
        ...
        [
            {"token": "HANS", "coord": "1;2;3;4;5;6;7:main", "normalized": "Hans"},
            {
                "token": "WORLD",
...
PARAMS_prep_person_out = [
    pytest.param(
        ...
        5,
        id="empty-gnd-ids-no-score-dist",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
        ...
        4,
        id="empty-gnd-ids-empty-score-dist",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
            ...
            "candidates": [
                {
                    "prefForename": ["Allie", "Marie"],
                    "prefSurname": ["Kann", "Meiér"],
                    "gid": "1",
                }
            ],
        },
        5,
        id="single-gnd-id-full-name-match",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
        ...
        4,
        id="single-gnd-id-full-name-mismatch",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
        ...
        4,
        id="multiple-gnd-ids-full-name-match-with-dist",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
        ...
        3,
        id="multiple-gnd-ids-full-name-mismatch-with-dist",
    ),
    pytest.param(
        {
            "firstname": ["Allie", "Marie"],
        ...
        3,
        id="multiple-gnd-ids-full-name-no-dist",
    ),
    pytest.param(
        {
            "firstname": [],
        ...
        4,
        id="single-gnd-id-abbrev-name-match",
    ),
    pytest.param(
        {
            "firstname": [],
        ...
        3,
        id="single-gnd-id-abbrev-name-mismatch",
    ),
    pytest.param(
        {
            "firstname": [],
        ...
        2,
        id="multiple-gnd-ids-abbrev-name-match",
    ),
    pytest.param(
        {
            "firstname": [],
        ...
        2,
        id="multiple-gnd-ids-abbrev-name-mismatch-with-dist",
    ),
    pytest.param(
        {
            "firstname": [],
        ...
        1,
        id="multiple-gnd-ids-abbrev-name-mismatch-no-dist",
    ),
]
PARAMS_get_candidates = [
    ...
    (
        {"lastname": ["Chatterjee"], "firstname": [], "abbr_firstname": ["S."]},
        "2004",
        15,
        5,
        {
